...
后续复核删除了修正文本中的“（按劳动力）”，数值、作用范围、修正名称及“无等级修正／有等级修正”分组均保留。生产方式法律条件也改为按定义区分：`unlocking_laws` 显示为“需要法律”，`disallowing_laws` 显示为“禁用法律”。公司总部的政府经营需要计划经济，劳动者合作社需要合作社所有制，私营所有制在计划经济或合作社所有制下禁用；英文界面使用相应英文标签。
