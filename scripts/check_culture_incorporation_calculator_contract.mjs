...
assert.match(indexHtml, /app\/culture-incorporation\.js\?v=20260828-culture-search1/);
...
assert.match(calculator, /compositionend/);
assert.match(calculator, /event\.isComposing/);
