...
assert.match(mainIndex, /styles\.css\?v=20260729-vc-entry3/, "main page must refresh the stylesheet cache version");
assert.match(mainIndex, /versions\.js\?v=20260729-vc-entry1/, "main page must refresh the library config cache version");
assert.match(mainIndex, /app\/runtime\.js\?v=20260729-vc-entry2/, "main page must refresh the runtime cache version");
assert.match(mainIndex, /app\/data\.js\?v=20260729-vc-entry1/, "main page must refresh the data cache version");
assert.match(mainIndex, /app\/ui\.js\?v=20260729-vc-entry2/, "main page must refresh the UI cache version");
