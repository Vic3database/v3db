...
const stateRegionTooltipResourceHtml = functionSource(components, "stateRegionTooltipResourceHtml");
requireMatch(functionSource(components, "stateRegionTooltipResourceChip"), /buildingIconHtml\(/, "state region tooltip resources must use building PNG icons");
requireMatch(stateRegionTooltipResourceHtml, /capped_resources/, "state region tooltip resources must include fixed resources");
requireMatch(stateRegionTooltipResourceHtml, /discoverable_resources/, "state region tooltip resources must include discoverable resources");
requireMatch(stateRegionTooltipResourceHtml, /arable_resources/, "state region tooltip resources must include agricultural resources");
requireMatch(functionSource(components, "stateRegionTooltipResourceChip"), /tooltip-resource-chip/, "state region tooltip resources need dedicated icon chips");
requireMatch(recordStyles, /\.tooltip-resource-chip\s*\{/, "state region tooltip resource chips need dedicated styles");
