...
assert.match(indexSource, /styles\.css\?v=20260828-home-tools1/, "culture incorporation map should invalidate the root stylesheet cache");
...
assert.match(indexSource, /locales\/manifest\.js\?v=20260828-company-solver-name1/, "country incorporation labels should invalidate the locale manifest cache");
