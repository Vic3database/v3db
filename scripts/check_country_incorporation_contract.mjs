...
assert.match(indexSource, /styles\.css\?v=20260827-culture-calculator-rework1/, "culture incorporation map should invalidate the root stylesheet cache");
assert.match(indexSource, /app\/map\.js\?v=20260826-culture-incorporation-refresh1/, "culture incorporation map should invalidate the map script cache");
...
assert.match(stylesSource, /styles\/shell\.css\?v=20260827-culture-calculator-rework1/, "culture incorporation map should invalidate the shell stylesheet cache");
