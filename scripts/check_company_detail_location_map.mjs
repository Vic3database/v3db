...
assert.match(styles, /\.company-detail-overview\s*{[\s\S]*grid-template-columns:\s*minmax\(0,\s*1fr\)\s+minmax\(0,\s*300px\)/, "historical company overview must cap the location map column at 300 pixels on wide screens");
