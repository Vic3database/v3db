...
assert.match(indexSource, /styles\.css\?v=20260802-resource-context-layout1/, "main entry must retain the current stylesheet cache version");
assert.match(stylesEntrySource, /@import url\("styles\/map\.css\?v=20260802-resource-context-layout1"\);/, "style entry must retain the current map stylesheet cache version");
