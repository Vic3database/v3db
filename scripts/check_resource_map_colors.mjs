...
assert.match(indexSource, /styles\.css\?v=20260802-province-terrain1/, "main entry must invalidate changed map styles");
assert.match(stylesEntrySource, /@import url\("styles\/map\.css\?v=20260802-province-terrain1"\);/, "style entry must invalidate the changed map stylesheet");
assert.match(indexSource, /app\/runtime\.js\?v=20260802-province-terrain1/, "main entry must invalidate the changed map runtime");
assert.match(indexSource, /app\/map\.js\?v=20260802-province-terrain1/, "main entry must invalidate the changed map script");
