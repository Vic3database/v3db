...
assert.match(functionSource(mapSource, "renderSubsistenceBuildingMapLegend"), /subsistence-building-map-legend-heading/, "the legend must explain the building-type color mapping");
...
assert.match(indexSource, /styles\.css\?v=20260805-subsistence-gradient1/, "main entry must invalidate the updated subsistence-map styles");
assert.match(indexSource, /app\/runtime\.js\?v=20260805-subsistence-gradient1/, "main entry must invalidate the updated subsistence-map runtime");
...
assert.match(indexSource, /app\/map\.js\?v=20260805-subsistence-gradient1/, "main entry must invalidate the updated subsistence-map script");
