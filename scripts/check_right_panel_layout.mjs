...
function checkDetailLayoutContracts() {
  ...
  assert(/styles\.css\?v=20260725-global-tag-layout1/.test(readText("site/index.html")), "detail title style changes should refresh the main stylesheet URL");
  assert(/styles\/records\.css\?v=20260725-global-tag-layout1/.test(readText("site/styles.css")), "detail title alignment should refresh the records stylesheet import");
  assert(/styles\/shell\.css\?v=20260720-map-frame/.test(readText("site/styles.css")), "removing the culture-only override should refresh the shell stylesheet import");
