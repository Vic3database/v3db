...
function checkDetailLayoutContracts() {
  ...
  assert(/styles\.css\?v=20260723-culture-tooltips1/.test(readText("site/index.html")), "detail title style changes should refresh the main stylesheet URL");
  assert(/styles\/records\.css\?v=20260723-culture-tooltips1/.test(readText("site/styles.css")), "detail title alignment should refresh the records stylesheet import");
